...
// Frontend User => Khách vãng lai chưa có đăng nhập
...
//  User account => Tác nhân đã đăng nhập
Route::group(['namespace' => 'User', 'prefix' => 'account'], function () {
    ...
    // Đẩy tin (cập nhật ngày đăng)
    Route::get('product/pushPost/{id}', [UserProductController::class, 'pushPost'])->name('get.user.pushPost');
    // Chat
