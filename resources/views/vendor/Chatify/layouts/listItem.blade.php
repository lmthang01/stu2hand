...
@if ($get == 'saved')
    <table class="messenger-list-item" data-contact="{{ Auth::user()->id }}">
        <tr data-action="0">
            ...
            {{-- center side --}}
            <td>
                <p data-id="{{ Auth::user()->id }}" data-type="user">Trò chuyện đã lưu <span>Bạn</span></p>
                <span></span>
            </td>
        </tr>
    </table>
        ...
        <tr data-action="0">
            ...
            <td style="position: relative">
                ...
                @php
                    ...
                    $urlSub = Str::after($urlAvatar, 'http://localhost:8000/storage/users-avatar/');
                    $user->avatar = $urlSub;
                @endphp
            ...
            <td>
                <p data-id="{{ $user->id }}" data-type="user">
                    {{ strlen($user->name) > 20 ? trim(mb_substr($user->name, 0, 20, 'UTF-8')) . '..' : $user->name }}
